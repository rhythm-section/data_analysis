class UserLocationsController < ApplicationController
  ...
  private
    ...
    def user_location_params
      params.require(:user_location).permit(:location_timestamp, :location_elapsed_realtime_nanos, :location_provider, :location_latitude, :location_longitude, :location_altitude, :location_speed, :location_accuracy, :location_app_session_id)
    end
end
